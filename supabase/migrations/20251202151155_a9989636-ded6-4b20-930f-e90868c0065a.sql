...
-- Weapons policies
CREATE POLICY "Users can view own weapons" ON public.weapons FOR SELECT USING (auth.uid() = user_id);
CREATE POLICY "Users can insert own weapons" ON public.weapons FOR INSERT WITH CHECK (auth.uid() = user_id);
CREATE POLICY "Users can update own weapons" ON public.weapons FOR UPDATE USING (auth.uid() = user_id);
CREATE POLICY "Users can delete own weapons" ON public.weapons FOR DELETE USING (auth.uid() = user_id);
